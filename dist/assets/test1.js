...
define('test1/routes/user', ['exports', 'ember'], function (exports, Ember) {
	...
	exports['default'] = Ember['default'].Route.extend({
		model: function model(params) {
			var user = Ember['default'].$.getJSON("https://api.github.com/users/" + params.username).then(function (data) {
				debugger;
			});
		}
	});
...
define('test1/tests/routes/user.jshint', function () {
  ...
  test('routes/user.js should pass jshint', function() { 
    ok(false, 'routes/user.js should pass jshint.\nroutes/user.js: line 6, col 9, Forgotten \'debugger\' statement?\nroutes/user.js: line 6, col 17, Missing semicolon.\nroutes/user.js: line 5, col 9, \'user\' is defined but never used.\nroutes/user.js: line 5, col 97, \'data\' is defined but never used.\n\n4 errors'); 
  });
...
if (runningTests) {
  ...
  require("test1/app")["default"].create({"name":"test1","version":"0.0.0.449a5346"});
}
